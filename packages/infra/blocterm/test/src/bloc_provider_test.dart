...
void main() {
  ...
  test('BlocProvider.create keeps its bloc when create changes', () async {
    await testNocterm('rebuild with a new create closure is a no-op', (
      tester,
    ) async {
      ...
      expect(first.closed, isFalse);
      expect(state.secondCreated, isNull);
    });
  });
